						...
						<div class="row">
							...
							<div class="col-sm-5" >
									<div class="d-flex  justify-content-between align-items-center">
										<small class="text-left">Start <span id="start_time"></span> Sec</small>
										<div id="slider" style="width: 50%;">
										</div>
									    <small class="text-right">End <span id="end_time"></span> Sec</small>
									</div>
							</div>	
							<div class="col-sm-2">
								<button class="btn  btn-neutral btn-sm  send_now float-right" type="button"><i class="ni ni-send"></i>&nbsp&nbsp{{ __('Send Now') }}</button>
							</div>
						</div>					
					</div>
				</div>
...
<script src="{{ asset('assets/js/pages/bulk/bulkmessage.js?v=1.3') }}" ></script>
